...
```bash
# .env.local
NEXT_PUBLIC_CLERK_PUBLISHABLE_KEY=pk_test_cmVsaWV2ZWQtZmxhbWluZ28tNDguY2xlcmsuYWNjb3VudHMuZGV2JA
CLERK_SECRET_KEY=sk_test_IQ5TTmOkerDbvvyZtwBxVCNoDjC1CZNDlRAerA5PKj
```
